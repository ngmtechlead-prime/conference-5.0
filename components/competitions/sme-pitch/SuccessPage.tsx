    ...
    <div className="min-h-[60vh] flex flex-col items-center justify-center py-12 px-4 font-epilogue">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-gray-600 text-base md:text-lg mb-8 max-w-xl mx-auto">
          Thank you for applying to the NGM CONFERENCE 5.0 SME PITCH
          COMPETITION. Your application has been successfully received. We will
          be reaching out to you via email soon to confirm whether you will
