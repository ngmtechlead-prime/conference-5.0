      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col font-epilogue">
        <div className="flex items-start justify-between p-6 border-b border-gray-100">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">{competition}</p>
          </div>
          <button
            onClick={onCancel}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          <p className="text-sm text-gray-600 italic">
            By submitting my application to the DARE Nigeria Challenge 2026, I
            confirm that I have read, fully understand and agree to the
            following terms and conditions, and I agree to be bound by them
          ...
          <div className="space-y-5">
            <section>
              ...
              <ul className="space-y-2 text-sm text-gray-600 list-disc pl-5">
                ...
                <li>
                  I confirm that I have not previously won the NGM SME
            ...
            <section>
              ...
              <ul className="space-y-2 text-sm text-gray-600 list-disc pl-5">
                ...
                <li>
                  If I am not yet a member, I understand I may apply for
                  membership concurrently with this application, but I must
                  achieve active membership status before I am permitted to
            ...
            <section>
              ...
              <ul className="space-y-2 text-sm text-gray-600 list-disc pl-5">
                <li>
                  ...
                  and have uploaded proof of purchase with this application.
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="space-y-2 text-sm text-gray-600 list-disc pl-5">
                ...
                <li>
                  ...
                  result in all my entries being disqualified.
                </li>
              </ul>
            </section>
          </div>
