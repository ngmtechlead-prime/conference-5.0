...
export const metadata: Metadata = {
  title: "Application Submitted | DARE Nigeria Challenge",
  description:
    "Your application to the DARE Nigeria Challenge 2026 has been successfully submitted.",
};
      ...
      <main className="flex-1 flex items-center justify-center py-16 px-4 sm:px-6 lg:px-12 font-epilogue">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-[#4A5565] mb-8">
            ...
            application has been successfully received. We will be reaching out
            to you via email soon to confirm whether you will proceed to the
            next round.
          </p>
